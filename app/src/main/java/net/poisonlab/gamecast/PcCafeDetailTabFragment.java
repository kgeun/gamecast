...
public class PcCafeDetailTabFragment extends ScrollTabHolderFragment{
    ...
    public static Fragment newInstance(int position) {
        PcCafeDetailTabFragment f = new PcCafeDetailTabFragment();
        Bundle b = new Bundle();
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        for (int i = 1; i <= 100; i++) {
            mListItems.add(i + ". item - currwewe2323232net page: " + (mPosition + 1));
        }
    }
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        mListView.setAdapter(new ArrayAdapter<String>(getActivity(), R.layout.detailtab_list_item, android.R.id.text1, mListItems));
